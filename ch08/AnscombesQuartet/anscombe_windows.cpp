...
int main() {
   ...
   std::string location{R"(c:\Users\PaulDeitel\Documents\)"};
   ...
   // We use gnuplot-cpp library's GnuplotPipe to send commands to 
   // gnuplot. Be sure to add the libraries folder gnuplot-cpp-windows
   // to your Visual C++ projects include path.
   GnuplotPipe pipe;

   // The rest of this program's statements send commands to gnuplot
   // using the GnuplotPipe pipe object's sendLine member function.
